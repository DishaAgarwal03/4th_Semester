//display key code of key read from matrix


#include <LPC17xx.h>
#include "WEEK8/q3_helper.c" // use all the functions of lcd program
//write "WEEK8/q3_helper.c" if C file where you are executing is outside WEEK8
...
0x14,0x24,0x44,0x84,
0x18,0x28,0x48,0x88};
//values are column,row where column/row 1,2,4,8 therefore 14=col1(1),row3(4) 
